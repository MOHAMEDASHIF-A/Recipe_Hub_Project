...
function Butter() {
  return (
    ...
    <Navbar/>
    <div className='struc'>
         <h1 className="recipe">Butter Chicken</h1>
         <h2>Ingredients</h2>
         <p>
            Butter,
            Chicken,
